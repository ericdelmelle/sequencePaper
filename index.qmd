...
author:
  ...
  - name: Eric Delmelle
    affiliations:
      - name: Vrije University Brussels, Belgium
        department: Geography
      - name: Dornsife School of Public Health, Drexel, U.S.A.
...
```{r silhouette-plots, warning=FALSE, cache=TRUE, message=FALSE, fig.show='hold', fig.cap="Silhouette Analysis for Different Cluster Sizes: (a) Four Clusters, (b) Five Clusters, and (c) Six Clusters.", fig.label='silhouette-analysis'}
...
```{r demographic-distribution, warning=FALSE, cache=TRUE, message=FALSE, fig.show='hold', fig.cap="Demographic Distribution of Labeled Clusters for Different Clustering Solutions: Four Clusters (top), Five Clusters (middle), and Six Clusters (bottom).", fig.label='demographic-distribution'}
