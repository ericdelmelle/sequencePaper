...
```{r kmeans1, warning=FALSE, cache=TRUE, message=FALSE, fig.show='hold', fig.label='clustering-analysis'}
...
```{r silhouette-plots, warning=FALSE, cache=TRUE, message=FALSE, fig.show='hold', fig.cap="Silhouette Analysis for Different Cluster Sizes: (top) Four Clusters, (middle) Five Clusters, and (bottom) Six Clusters.", fig.label='silhouette-analysis'}
...
```{r explore-demographics, warning=FALSE, cache=TRUE, message=FALSE, fig.show='hold', fig.cap="Geographic variation of Labeled Clusters for Different Clustering Solutions.", fig.label='demographic-makeup'}
...
```{r smallmultiples,warning=FALSE, cache=TRUE, message=FALSE, fig.show='hold', fig.cap="Change in the cluster memmbership over five decades.", fig.label='clusterChange'}
