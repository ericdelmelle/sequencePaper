...
```{r visualize-area, warning=FALSE, cache=TRUE, message=FALSE, fig.width=10, fig.height=8}
#| label: nyc-plot
#| fig-cap: "Overview map of New York City's five boroughs and surrounding counties."
...
```{r AsianPathways, echo=FALSE, warning=FALSE, message=FALSE}
